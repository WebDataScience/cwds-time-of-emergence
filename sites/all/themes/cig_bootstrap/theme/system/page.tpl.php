            ...
            <div class="inner-wrap">
                <nav class="tab-bar show-for-small-only">
                    <section class="left-small mobile-logo">
                        <a href="http://cig.washington.edu" rel="home" title="Climate Impacts Group">
                    ...
                    <section class="middle tab-bar-section">
                        <a href="http://cig.washington.edu" rel="home" title="Climate Impacts Group">
                            <h1 class="title">Climate Impacts Group</h1>
                        </a>
                    </section>
                ...
                <div class="banner-container"> 
                    <div class="row title-row">
                        <div class="columns medium-2 name show-for-medium-up">
                            <a class="logo" href="http://cig.washington.edu" rel="home" title="Climate Impacts Group">
                                <!--[if gte IE 9]><!-->
                    ...
                    <div class="columns large-8 medium-10 show-for-medium-up">
                        <div id="unit-college-uw" class="centered">
                            <h1 class="left"><a href="http://cig.washington.edu" rel="home" title="Climate Impacts Group">Climate Impacts Group</a></h1>
                            <div class="units show-for-large-up right">
                                <a href="http://coenv.uw.edu" title="UW College of the Environment"><img src="/sites/all/themes/cig_bootstrap/cig/assets/img/College-of-the-Environment.png" class="college-name" alt="College of the Environment"></a><br />
                                <a href="http://uw.edu" title="University of Washington"><img src="/sites/all/themes/cig_bootstrap/cig/assets/img/UW-Tagline.png" class="uw-name" alt="University of Washington"></a>
                            </div>
                        </div>
                    </div>
                    <div class="columns large-2 show-for-large-up">
                        <a href="http://uw.edu" title="University of Washington"><img src="/sites/all/themes/cig_bootstrap/cig/assets/img/logo-cig-header.png" class="right" alt="Climate Impacts Group Logo" /></a>
                    </div>
                </div>
            </div>
            <div class="top-bar-container show-for-medium-up">
                <nav class="top-bar">
                    <section class="top-bar-section"><!-- usually contains main site navigation --></section>
                </nav>
            </div>
...
-->
                    ...
                    <aside id="sidebar" class="small-12 medium-3 columns">
                        <article id="coenv_base_subnav-2" class="row widget widget_coenv_base_subnav">
                            <ul class="side-nav">
                                <li class="active"><a href="#" class="active">Read</a></li>
                                <li><a href="#">Tour</a></li>
                ...
                <div class="footer-row">
                    <div class="row">
                        <div class="medium-6 columns">
                            <div class="footer-logo left">
                                <img src="/sites/all/themes/cig_bootstrap/cig/assets/img/logo-color.png" alt="Climate Impacts Group Logo" />
                            </div>
                    ...
                    <div class="medium-6 columns right">
                        <nav class="footer-nav">
                            <header class="site-footer__header">
                                <h2 id="logo"><a href="http://coenv.washington.edu/" rel="home" title="UW College of the Environment"><img alt="College of the Environment Logo" src="/sites/all/themes/cig_bootstrap/cig/assets/img/uw-footer.svg" width="350" ></a></h2>
                            </header>
    ...
    <a class="exit-off-canvas"></a>
        ...
        <script type='text/javascript' src='/sites/all/themes/cig_bootstrap/cig/js/app.js?ver=1.0.0'></script>
